...
:root {
  ...
  --foreground: #F0FAF9;
  --card: #ffffff;
  --card-foreground: #0D1F1E;
  --popover: #ffffff;
  --popover-foreground: #0D1F1E;
  --primary: #FF6835;
  --primary-foreground: #ffffff;
  --secondary: #148A7D;
  --secondary-foreground: #F0FAF9;
  --muted: #117A6E;
  --muted-foreground: #7ECFC8;
  --accent: #FFD60A;
  --accent-foreground: #0D1F1E;
  --destructive: #d4183d;
  --destructive-foreground: #ffffff;
  --border: rgba(255, 255, 255, 0.15);
  --input: transparent;
  --input-background: #148A7D;
  --switch-background: #1B998B;
